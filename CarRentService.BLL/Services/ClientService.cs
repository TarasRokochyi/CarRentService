...
namespace CarRentService.BLL.Services
{
    public class ClientService : IClientService
    {
        ...
        public async Task<DAL.Models.Client> AddClientToSystemAsync(ClientRequestDTO clientDTO, CancellationToken cancellationToken)
        {
            try
            {
                DAL.Models.Client client = _mapper.Map<DAL.Models.Client>(clientDTO);
        ...
        public async Task<DAL.Models.Client> UpdateClientInSystemAsync(int id, ClientDTO clientDTO, CancellationToken cancellationToken)
        {
            ...
            try
            {
                await _unitOfWork.ClientRepository.UpdateAsync(_mapper.Map<DAL.Models.Client>(clientDTO));
                await _unitOfWork.CompleteAsync(cancellationToken);
